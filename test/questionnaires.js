...
describe('Questionnaires', function () {
  ...
  it("GET /api/questionnaires as non-super shouldn't show questionnaires", function (done) {
    rAgent
  ...
  it("GET /api/questionnaires/new/ as non-super shouldn't show form", function (done) {
    rAgent
      .get('/api/questionnaires/new/')
      .expect(400, done)
  })
  ...
  it("GET /api/questionnaires/x as non-super shouldn't show questionnaires", function (done) {
    rAgent
      .get('/api/questionnaires/x')
      .expect(302, done)
  })

  it("DELETE /api/questionnaires/x as non-super shouldn't delete new questionnaires", function (done) {
    rAgent
      .delete('/api/questionnaires/x')
      .expect(302)
      .expect(/^((?!test).)*$/, done)
  })

  it("DELETE /api/questionnaires/invalid as non-super shouldn't delete", function (done) {
    rAgent
      .delete('/api/questionnaires/unknown' + '/delete')
      .expect(400, done)
  })

  it('GET /api/questionnaires/api as non-super should return JSON', function (done) {
    rAgent
      .get('/api/questionnaires/api')
      .expect(200, done)
  })
