    ...
    angular
        ...
        .constant('APP_REQUIRES', {
          ...
          modules: [
            ...
            {name: 'ui.sortable',               files: ['vendor/angular-ui-sortable/sortable.js']},
...
(function() {
    ...
    function settingsRun($rootScope, $localStorage){
      ...
      // -----------------------------------
      $rootScope.app = {
        name: 'Landscape Connect',
        description: 'Created by Plymouth University',
...
(function() {
    ...
    angular
        .module('app.questions')
        .service('questionnairesDataService', questionnairesDataService);

    function questionnairesDataService() {
        /* jshint validthis:true */
        var self = this;
        this.cache = null;
        this.getData = getData;
